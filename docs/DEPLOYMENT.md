...
6. **Run Database Migrations & Seed**:
   ...
   npm run seed
   ```
   *(This creates the database tables and initializes the default admin user: `admin@bricksnbeyond.com` with password `Admin@12345`).*
...
1. **Test Login**:
   ...
   * Log in with `admin@bricksnbeyond.com` and `Admin@12345`.
