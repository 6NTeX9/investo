...
export const metadata: Metadata = {
  title: "About Us | Aurum Estate",
  description: "Aurum Estate is a premium real estate advisory firm helping clients find luxury residential and commercial properties across India's top cities."
};
...
const values = [
  {
    ...
    body: "Every listing on Aurum Estate is hand-picked and verified. We work only with trusted builders and offer only properties that meet our quality benchmark."
  },
  {
    icon: Users,
      ...
      <section className="section-shell pt-16 pb-16 grid gap-10 lg:grid-cols-2 items-center">
        <div>
          ...
          <p className="mt-6 text-lg text-[#4f4942] leading-8 max-w-lg">
            Aurum Estate was founded with a single mission — to make luxury real estate accessible, transparent, and stress-free for every Indian family and investor.
          </p>
