...
export const metadata: Metadata = {
  title: "Insights & Market Reports | Aurum Estate",
  description: "Stay informed with the latest real estate market insights, investment guides, and property trends from Aurum Estate's expert advisory team."
};
