...
export const properties: Property[] = [
  {
    ...
    siteArea: "4.8 acres",
    builder: "Aurum Developments",
    nearby: ["Dubai Mall - 6 min", "Business Bay - 8 min", "DIFC - 12 min"],
    agent: {
      name: "Maya Kapoor",
      phone: "+971 55 210 7788",
  ...
  },
  {
    ...
    title: "Marina Gate Villas",
    city: "Dubai",
    location: "Palm Waterfront",
    address: "Palm Jumeirah Crescent, Dubai",
    priceLabel: "From AED 8.6M",
    price: 8600000,
    type: "Villa",
    bedrooms: 5,
    ...
    amenities: ["Private beach", "Cinema room", "Smart home", "Garden deck", "Boat berth"],
    description: "Waterfront villas with generous indoor-outdoor living, private pools, and direct promenade access.",
    siteArea: "7,900 sq.ft.",
    builder: "Noble Coast",
    nearby: ["Atlantis - 7 min", "Dubai Marina - 15 min", "JBR - 18 min"],
    agent: {
      name: "Omar Siddiqui",
      phone: "+971 58 903 2244",
      email: "omar@aurumestate.com",
  ...
  },
  {
    ...
    siteArea: "32 floors",
    builder: "Civic Stone",
    nearby: ["Canal promenade - 2 min", "Downtown - 8 min", "DXB Airport - 18 min"],
    agent: {
      name: "Elena Rossi",
      phone: "+971 52 118 4421",
      email: "elena@aurumestate.com",
...
export const testimonials = [
  ...
  "Aurum helped us compare yield, location fundamentals, and exit scenarios before we committed."
];
