...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-black/10 bg-[#f7f4ee]/90 backdrop-blur-xl">
      <nav className="section-shell flex h-16 sm:h-20 items-center justify-between">
        ...
        <div className="flex items-center gap-2 lg:hidden">
          <a
            ...
            className="flex items-center gap-1.5 rounded-md border border-black/10 bg-white/70 px-2.5 py-1.5 text-xs font-semibold text-[#171717] transition hover:bg-white"
          ...
          <button
            type="button"
            className="grid size-10 place-items-center rounded-md border border-black/10 bg-white/70 transition hover:bg-white"
      ...
      <div
        className={`backdrop-overlay absolute inset-x-0 top-full z-40 h-[calc(100dvh-4rem)] bg-black/30 backdrop-blur-[2px] lg:hidden transition-opacity duration-300 ${
      ...
      <div
        ...
        className={`absolute right-0 top-full z-50 h-[calc(100dvh-4rem)] w-[min(86vw,22rem)] overflow-y-auto border-l border-black/10 bg-[#f7f4ee] px-6 py-6 shadow-2xl lg:hidden transition-transform duration-300 ease-out ${
