...
async function main() {
  ...
  const agent = await prisma.agent.upsert({
    where: { email: "maya@bricksnbeyond.com" },
    update: {},
    create: {
      name: "Maya Kapoor",
  ...
  await prisma.agent.upsert({
    where: { email: "sarah.j@bricksnbeyond.com" },
    update: {},
    create: {
      name: "Sarah Jenkins",
      email: "sarah.j@bricksnbeyond.com",
      phone: "+919876543211",
  ...
  await prisma.agent.upsert({
    where: { email: "alexander.w@bricksnbeyond.com" },
    update: {},
    create: {
      name: "Alexander Wright",
      email: "alexander.w@bricksnbeyond.com",
      phone: "+919876543212",
  ...
  await prisma.agent.upsert({
    where: { email: "elena.r@bricksnbeyond.com" },
    update: {},
    create: {
      name: "Elena Rossi",
      email: "elena.r@bricksnbeyond.com",
      phone: "+919876543213",
  ...
  await prisma.property.upsert({
    ...
    create: {
      ...
      bathrooms: 4,
      siteArea: "4.8 acres",
      builderName: "BricksNBeyond Developments",
